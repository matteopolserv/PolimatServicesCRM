        ...
        public async Task<bool> SendInvoiceToClient(PdfFileModel invoice, string clientEmail)
        {
            ...
            try
            {
                await Task.Run(async () =>
                {
                    ...
                    smtp.Authenticate("matteo@polserv.pro", "VeryStrongPassword");
                    smtp.Send(email);
